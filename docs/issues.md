...
- The local server startup hook now runs `scripts/update-insights.mjs`; generated summaries are deterministic template summaries unless a future LLM-backed generation step is added.
